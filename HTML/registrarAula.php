...
<div class='contenido_completo'>
  $msj
    <form class='form-buscar' action='' method='post' id='idFbuscar'>
      ...
      $vistaTabla=tablaAula($conexion,$id);
...
<script>
  function agregarRegistro(){
    ...
    document.location.href="registrarAula.php#nuevoRegistro";
  }
...
<?php echo $vistaTabla; ?>
  <div id="nuevoRegistro" class="modalDialog">
    <form class="form-resalto" action="../PHP/procesarAula.php"
